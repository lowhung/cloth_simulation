...
const double gInvalidLikelihood = -1;
const double gInchesToMeters = 0.0254;

class PLUGIN_EXPORT cMathUtil
{
public:
	enum eAxis
	{
	...
	static double EvalGaussianUnnormalized(const Eigen::VectorXd& mean, const Eigen::VectorXd& covar, const Eigen::VectorXd& sample);
