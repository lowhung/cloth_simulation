...
void cCamera::MouseClick(int button, bool down, int modifiers, double x, double y)
{
	mMouseDown = (button == GLFW_MOUSE_BUTTON_2) && down;
...
void cCamera::MouseScroll(double dx, double dy)
{
	double zoom = dy * 0.05;
	Zoom(zoom);
}
